            ...
            <div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid>
                <div class="uk-width-1-1@m">
                    <div class="uk-margin uk-width-large uk-margin-auto uk-card uk-card-default uk-card-body uk-box-shadow-large" style="border-radius: 15px">
                        <h3 class="uk-card-title uk-text-center" style="font-weight: 400; padding: 10px">Source Upload</h3>
                        <form method="post" enctype="multipart/form-data">

                            <div class="uk-margin">
                                <div class="uk-inline uk-width-1-1">
                                    <span class="uk-form-icon" uk-icon="icon: file-text"></span>
                                    <input value="${name}" style="border-radius: 10px"  name="sourceFileName" placeholder="Source Name" class="uk-input uk-form-large" type="text">
                                </div>
                            </div>
                            <div class="uk-margin">
                                <div class="uk-inline uk-width-1-1">
                                    <div class="uk-margin">
                                        ...
                                        <select name="sourceFileFormat"  style="border-radius: 10px; height: 55px; padding-left: 40px" ; class="uk-select">
                                            <option>CSV</option>
                                            <option>JSON</option>
                                        </select>
                                    </div></div>
